            ...
            <div class="p-10 w-full flex flex-col gap-10">
                <div class="w-full flex flex-wrap gap-10 items-center justify-center">
                    ...
                    <a href="#" class="hover:scale-105 duration-150 ease-in-out w-80 h-56 rounded-3xl leading-6 shadow-2xl shadow-slate-200 ring-1 ring-gray-900/5 p-10 flex flex-col justify-around">
                        ...
                        <p class="capitalize text-5xl font-bold"><?= isset($data) ? $data['data']['numberOfProducts']: 0; ?></p>
                    </a>
                    <a href="<?= \Helpers\URLHelper::appendToBaseURL('dashboard/orders/manage-orders') ?>?duration=sinceTheBeginning" class="hover:scale-105 duration-150 ease-in-out w-80 h-56 rounded-3xl leading-6 shadow-2xl shadow-slate-200 ring-1 ring-gray-900/5 p-10 flex flex-col justify-around">
                    ...
                    <a href="<?= \Helpers\URLHelper::appendToBaseURL('dashboard/orders/manage-orders') ?>?duration=resentOrders" class="hover:scale-105 duration-150 ease-in-out w-80 h-56 rounded-3xl leading-6 shadow-2xl shadow-slate-200 ring-1 ring-gray-900/5 p-10 flex flex-col justify-around">
                        <p class="capitalize text-2xl font-medium">Number of orders</p>
                ...
                <div class="flex flex-col gap-5">
                    <h1 class="capitalize font-bold text-4xl">recent orders</h1>
                    <div class="overflow-x-auto shadow-md sm:rounded-lg" id="orders-table">
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                            ...
                            <tbody class="text-lg">
                                <?php
                                if (isset($data)): foreach ($data['data']['resentOrders'] as $order):
                                ...
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 flex flex-col gap-3">
                                        ...
                                        <a href="<?=  \Helpers\URLHelper::appendToBaseURL('dashboard/UpdateOrder/') . $order['order_ID'] ?>" class="w-20 h-10 flex items-center justify-center bg-turquoise-splash hover:bg-emerald-envy text-lg font-bold tracking-wide capitalize truncate text-white rounded-lg  duration-150">update</a>
                                    </td>
                                    <td class="px-6 py-4 font-semibold text-gray-900">
                                        <?= $order['create_date'] ?>
                                    </td>
